...
export const CatppuccinPreset = definePreset(Aura, {
    semantic: {
        primary: {
            ...
            dark: {
                50: '#f5e0dc', 100: '#f2cdcd', 200: '#f5c2e7', 300: '#cba6f7',
                400: '#b4befe', 500: '#89b4fa', 600: '#74c7ec', 700: '#94e2d5',
                800: '#a6e3a1', 900: '#f9e2af'
            }
        },
        surface: {
            light: {
            ...
            dark: {
                0: '#1e1e2e', 100: '#181825', 200: '#11111b',
                300: '#313244', 400: '#45475a', 500: '#585b70'
            }
        },
        accent: {
            light: {
            ...
            dark: {
                100: '#fab387', 200: '#eba0ac', 300: '#f38ba8'
            }
        },
        text: {
            light: {
            ...
            dark: {
                DEFAULT: '#cdd6f4', subtext0: '#a6adc8', subtext1: '#bac2de'
            }
        },
        overlay: {
            light: {
                overlay0: '#e5e5e5', overlay1: '#d4d4d4', overlay2: '#a1a1aa'
            },
            dark: {
